...
#from rlgym_compat.utils.action_parsers import ActionParser
#from rlgym_compat.utils.gamestates import GameState


#from rlgym_compat.utils.action_parsers import ContinuousAction, DiscreteAction
...
class YourActionParser:
    ...
    def parse_action(self, action, state) -> np.ndarray:
        indexes = np.array(action, dtype=np.int32)
